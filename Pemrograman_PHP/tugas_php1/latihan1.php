...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <img
        src="https://i.ibb.co/j4tGJ4m/Belajar-Siang.png"
        alt="Foto Profil Github"
      />
    ...
    <fieldset id="pendidikan">
      ...
      <ol type="1">
        ...
        <li>Tempat Lahir: Makassar</li>
        <li>Tanggal Lahir: 03 Oktober 2001</li>
        <li>
    ...
    <fieldset id="galeri">
      ...
      >
        <img
          src="https://th.bing.com/th/id/R.c76fdc3d84da569eb11df27244361d8d?rik=na4iVfLOtoE%2fVw&riu=http%3a%2f%2fcliparts.co%2fcliparts%2frTn%2frAn%2frTnrAnXxc.jpg&ehk=pg4klpZW7k0f5XqKBxeIPVlA03BdwbrizZVD6cJPTQw%3d&risl=&pid=ImgRaw&r=0"
          alt=""
          srcset=""
          width="20%"
        />
        <img
          src="https://www.wallpapertip.com/wmimgs/11-114646_wallpaper-kungfu-panda-in-action-gambar-kartun-lucu.jpg"
          alt=""
          srcset=""
          width="20%"
        />
        <img
          src="https://howieandbelle.com/wp-content/uploads/2018/10/gambar-kartun-lucu-3d.jpg"
          alt=""
          srcset=""
          width="20%"
        />
      ...
      >
        <img
          src="https://sharingconten.com/wp-content/uploads/2020/01/Gambar-Kartun-Lucu-dan-Imut.jpg"
          alt=""
          srcset=""
          width="20%"
        />
        <img
          src="https://www.pinclipart.com/picdir/big/577-5777017_kartun-hewan-kucing-lucu-clipart.png"
          alt=""
          srcset=""
          width="20%"
        />
        <img
          src="https://1.bp.blogspot.com/-ZT68un-Wczw/XtFdVzTUtfI/AAAAAAAAKcs/OLIOI-nW358j2sYink7Ci4EFhSNtH6lwgCLcBGAsYHQ/s1600/cropped-cute-agnes-gru-despicable-me2.jpg"
          alt=""
          srcset=""
          width="20%"
        />
